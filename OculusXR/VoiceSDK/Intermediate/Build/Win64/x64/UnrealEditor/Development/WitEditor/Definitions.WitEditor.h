...
#define WITH_VOICESDK 1
#define WITH_VOICESDK_MARKETPLACE 1
#define UE_MODULE_NAME "WitEditor"
#define UE_PLUGIN_NAME "VoiceSDK"
#define WITEDITOR_API DLLEXPORT
